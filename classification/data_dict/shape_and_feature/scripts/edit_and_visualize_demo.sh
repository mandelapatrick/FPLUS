...
TEXTURE_FEAT_NUM=8
ROOT_DIR='/Users/mandelapatrick/Downloads/FashionPlusLocal' # absolute path for FashionPlus
...
############### UPDATE AND GENERATE  ###############
exec_options="python ${ROOT_DIR}/classification/data_dict/shape_and_feature/update_demo.py \
...
python ${ROOT_DIR}/postprocess/process_face.py \
